            ...
            if($result) {
                ...
                <body id='event-add-success-pg'>
                    <div class='event-added-details'>
                        ...
                        <h4>You left a $starCount Star Feedback to the Event.</h4>
                    ...
                    <div class='event-added-details'>
                        ...
                        <script>
                            var animation = bodymovin.loadAnimation({
                                ...
                                loop: true,
                                autoplay: true,
                                path: 'assets/json/red_unsuccess.json'
                            });
                        </script>
                        <h3>Feedback Added Successfully!</h3>
                        <h4>Something went wrong with sending feedback.</h4>
